...
-- Activate ZenMode
keymap.set("n", "<leader>z", ":ZenMode<enter>", { desc = "activate ZenMode" })

-- Open Terminal
keymap.set("n", "<leader>ñph", ":split term://powershell<enter>", { desc = "open powershell horizontally" })
keymap.set("n", "<leader>ñpv", ":vsplit term://powershell<enter>", { desc = "open powershell vertically" })

keymap.set("n", "<leader>ñch", ":split term://cmd<enter>", { desc = "open cmd horizontally" })
keymap.set("n", "<leader>ñcv", ":vsplit term://cmd<enter>", { desc = "open cmd vertically" })

keymap.set("n", "<leader>ñuh", ":split term://ubuntu<enter>", { desc = "open ubuntu horizontally" })
keymap.set("n", "<leader>ñuv", ":vsplit term://ubuntu<enter>", { desc = "open ubuntu vertically" })

-- Tabs
keymap.set("n", "<leader>tn", ":bnext<enter>", { desc = "switch to next tab" })
keymap.set("n", "<leader>tp", ":bprev<enter>", { desc = "switch to previous tab" })

-- NvimTree
keymap.set("n", "<leader>r", ":NvimTreeToggle<enter>", { desc = "toggle nvimTree" })
